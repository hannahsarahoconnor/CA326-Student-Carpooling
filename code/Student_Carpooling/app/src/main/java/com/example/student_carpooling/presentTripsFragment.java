...
public class presentTripsFragment extends Fragment  {
    ...
    private String UserID, Date, Destination, Seats, Starting, LuggageCheck, Time,UserName,TripID;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView tripRecyclerView = v.findViewById(R.id.trippresentRecycler);
        ...
        PresentTripAdapter = new TripAdapter(getDataTrips(),getContext());
