    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_message:
                Intent msg = new Intent(UserMessage.this, UserMessage.class);
                startActivity(msg);
                break;

            case R.id.nav_profile:
                Intent profile = new Intent(UserMessage.this, UserProfile.class);
            ...
            case R.id.nav_create_trips:
                Intent create = new Intent(UserMessage.this, DriverCreate.class);
                startActivity(create);
                break;

            case R.id.nav_my_trips:
                Intent trips = new Intent(UserMessage.this, DriverTrips.class);
                startActivity(trips);
                break;
        }
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(UserMessage.this, "Sign Out", Toast.LENGTH_SHORT).show();
